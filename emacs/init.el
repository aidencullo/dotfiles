...
(custom-set-variables
 ...
 '(package-selected-packages
   '(vue-mode swift-mode typescript-mode auto-complete compat git-commit magit-section transient with-editor expand-region yasnippet monokai-theme grep-a-lot paredit magit company ##))
